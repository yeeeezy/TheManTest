...
| `Source/TheManTest/Public/UI/Combat/CombatHUDWidgetBase.h` / `.cpp` | 原生战斗 HUD：视口中心半径32px、线宽2px的64段空心圆；右下两行当前弹药/容量与备用弹夹；Slate Paint 绘制、Hit Test Invisible、事件驱动更新 |
