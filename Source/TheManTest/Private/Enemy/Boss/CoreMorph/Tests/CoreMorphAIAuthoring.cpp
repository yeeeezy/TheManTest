...
bool FCoreMorphAuthorAI::RunTest(const FString&)
{
 ...
 BB->Keys.Reset();
 for(FName Key:{FName("Manta"),FName("CombatReady"),FName("CanStrike"),FName("NeedsApproach")}){FBlackboardEntry E;E.EntryName=Key;E.KeyType=NewObject<UBlackboardKeyType_Bool>(BB);BB->Keys.Add(E);}
 ...
 AddTask(Manta,ECoreMorphTreeAction::Flight,TEXT("Flight GA"));AddTask(Manta,ECoreMorphTreeAction::Reassemble,TEXT("Reassemble GA"));
